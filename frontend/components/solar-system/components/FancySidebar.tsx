          ...
          <div className="flex items-center justify-between">
            {!isCollapsed && (
              <div>
                ...
                <p className="text-sm text-gray-400">Objects & Information</p>
              </div>
            )}
            <button
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="p-4 border-b border-gray-700/30">
              <ExpandableItem
                ...
                color="#FFD700"
                isActive={targetPlanetKey === 'sun'}
                onClick={onResetCamera}
              >
                <div className="text-sm text-gray-300 space-y-2">
                  <div>🌡️ Surface: ~5,778 K</div>
                  <div>📏 Radius: 696,340 km</div>
                  <div>⚖️ Mass: 1.989 × 10³⁰ kg</div>
                  <div>🔥 Core: Nuclear fusion</div>
                </div>
              </ExpandableItem>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="p-4">
                <h3 className="text-lg font-semibold text-white mb-3">🪐 Planets</h3>
              ...
              <div className="p-4 border-t border-gray-700/30">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-lg font-semibold text-white">☄️ Near-Earth Objects</h3>
